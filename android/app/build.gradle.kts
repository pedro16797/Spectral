...
// `flutter run --release` still works locally — but such builds must never
// be distributed (the Play Store rejects them, and installs could not be
// updated by a properly signed release later).
